...
const TaskActionMenu = ({ task, canManageTasks = true, onPreview, onEdit, onDelete }) => {
        ...
        >
          {onPreview && (
            <button
              ...
              className="w-full px-3 py-2 text-xs text-on-surface hover:bg-surface-container-highest flex items-center gap-2 transition-colors cursor-pointer bg-transparent border-none text-left font-medium"
            >
              ...
              {onDelete && (
                <>
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2 text-xs text-error hover:bg-error/10 flex items-center gap-2 transition-colors cursor-pointer bg-transparent border-none text-left font-medium"
                  >
